...
function parseFilters(req) {
  ...
  const normDay = ["today", "tomorrow", "yesterday", "all"].includes(day) ? day : "today";
...
async function rssMaintenanceOnce() {
  ...
  for (const it of items) {
    ...
    // ✅ DŮLEŽITÉ: ESP posílá jako ID vždy "link". Pokud bychom použili GUID,
    // vznikaly by duplicity a RSS by nikdy neaktualizovalo záznamy z ESP.
    const id = link;
